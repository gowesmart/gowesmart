    ...
    return (
        <section className="py-5 flex justify-between items-center">
            <div className="bg-tertiary p-5 flex justify-center items-center gap-5 rounded-md border border-accent">
                <div className="text-[48px]"><i className="fa-solid fa-money-bill-transfer"></i></div>
                <div>
            ...
            <div className="bg-tertiary p-5 flex justify-center items-center gap-5 rounded-md border border-accent">
                <div className="text-[48px]"><i className="fa-solid fa-truck-fast"></i></div>
                <div>
            ...
            <div className="bg-tertiary p-5 flex justify-center items-center gap-5 rounded-md border border-accent">
                <div className="text-[48px]"><i className="fa-solid fa-screwdriver-wrench"></i></div>
                <div>
            ...
            <div className="bg-tertiary p-5 flex justify-center items-center gap-5 rounded-md border border-accent">
                <div className="text-[48px]"><i className="fa-solid fa-store"></i></div>
                <div>
