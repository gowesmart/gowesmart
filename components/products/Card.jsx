...
const ProductCard = ({
  ...
  return (
    <Link href={link} className="w-[280px] h-[406px] rounded-md border border-accent bg-gradient-to-br from-[rgba(67,67,67,0.2)] to-[rgba(14,14,14,0.2)] p-10 flex flex-col justify-center items-center">
